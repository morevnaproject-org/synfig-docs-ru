...
«**Scale**» можно использовать на [Углы](../docs/Convert/#Angle), [Цвет](../docs/Convert/#Color), [Целые числа](../docs/Convert/#Integer), [Действительные значения](../docs/Convert/#Real), [Времена](../docs/Convert/#Time) и [Векторы](../docs/Convert/#Vector).
