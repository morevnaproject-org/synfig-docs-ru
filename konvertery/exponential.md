...
Это полезно для отслеживания слоев, которые были увеличены, поскольку слой [Масштабирования](/docs/Zoom_Layer) масштабируется на e ^ (коэффициент масштабирования).
