...
После выбора инструмента курсор мыши примет форму **карандаша**.\
Выделите **слой**, который нужно отредактировать, и обведите область, которую хотите вырезать.

После этого на **Панели слоёв** автоматически создаётся **группа**, содержащая **маску** и **слой с редактируемым объектом**.
...
Через **Панель параметров** можно изменять параметры **слоя-маски**, такие как **непрозрачность**, **метод наложения**, **растушёвка** и другие. Для изменения значения параметра дважды щёлкните по его полю.

{% hint style="info" %}
Подробную информацию см. в разделе «**Инструменты**».
{% endhint %}
