...
| [![Type real icon.png](https://wiki.synfig.org/images/thumb/f/fd/Type_real_icon.png/16px-Type_real_icon.png)](https://wiki.synfig.org/File:Type_real_icon.png) Непрозрачность | 0.500000           | real   |
| [![Type string icon.png](https://wiki.synfig.org/images/thumb/6/63/Type_string_icon.png/16px-Type_string_icon.png)](https://wiki.synfig.org/File:Type_string_icon.png) Имя    | skeleton           | string |
