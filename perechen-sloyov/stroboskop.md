...
![](../.gitbook/assets/layer_other_stroboscope_icon.png)
...
{% hint style="info" %}
С помощью слоя у вас может получиться две разные анимации с двумя разными частотами кадров в одном проекте. Например, если вы сгруппируете стробоскоп с вашей анимацией и установите частоту `12`, то анимация секвенции будет проигрываться `12` кадров в секунду. При этом, плавный параллакс так и останется на частоте `24` кадра в секунду&#x20;
{% endhint %}
