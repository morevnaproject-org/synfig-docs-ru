...
**Создание слоя «Расширенный контур»** осуществляется несколькими способами:

* На **Панели слоёв** с помощью кнопки **«Создать слой»** вызовите контекстное меню и выберите: **«Геометрия» → «Расширенный контур»**
