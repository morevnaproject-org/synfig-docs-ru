...
<div align="left"><figure><img src="../.gitbook/assets/layer_geometry_advanced_outline_icon (1).png" alt=""><figcaption></figcaption></figure></div>

**Супер-контур** — это усовершенствованный слой **Контур** с дополнительными параметрами, обеспечивающий более гибкое и точное управление контуром фигуры.

### **Создание слоя Супер-контур**

**Создание слоя Супер-контур** осуществляется несколькими способами:

* На **Панели слоёв** с помощью кнопки **Создать слой** вызовите контекстное меню и выберите: **Геометрия → Супер-контур**

<figure><img src="../.gitbook/assets/2024-05-16_15-48.png" alt=""><figcaption></figcaption></figure>

* С помощью инструментов, которые создают редактируемые фигуры (в том числе инструмент **Кривые**). Для этого выберите нужный инструмент и в параметрах этого инструмента кликните на иконку с расширенным контуром. После создания фигуры, создастся и Супер-контур.

<figure><img src="../.gitbook/assets/2024-05-16_15-42.png" alt=""><figcaption></figcaption></figure>

### **Отличия от слоя Контур**

В обычном слое **Контур** каждая управляющая шириной точка связан с вершиной, определяющей форму контура в конкретном месте.&#x20;
...
Параметры **точки ширины** в **Супер-контуре**:
...
| Не заострённая остановка          | <p></p><p><img src="../.gitbook/assets/7.png" alt="" data-size="original"></p>     |
