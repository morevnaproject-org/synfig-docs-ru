...
Флажок «Использовать параметрический» позволяет использовать [Параметрический рендеринг](../docs/index.php) вместо стандартного [Ускоренный рендеринг](../docs/index.php).
