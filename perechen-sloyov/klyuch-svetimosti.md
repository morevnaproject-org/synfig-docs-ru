...
Слой «**Ключ светимости**» выполняет следующие действия: для каждого пикселя изображения он присваивает значение альфа в зависимости от его яркости. Например, черные пиксели становятся на 100% прозрачными. Белые пиксели абсолютно непрозрачны. Серые пиксели полупрозрачны.

Параметры ключевых слоев **Luma** следующие:<br>
