...
Для создания вложенного холста сгруппируйте объекты. Затем на панели **Параметры слоя** выберите параметр **Холст**, нажмите **ПКМ** и выберите пункт **Экспортировать…**\
