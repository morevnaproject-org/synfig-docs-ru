...
Для того, чтобы создать вложенный холст, следует сгруппировать объекты, затем, выделив группу на панели «Параметров слоя» выберите параметр «Холст» и щелкните **ПКМ** → «Экспортировать…»\
...
После создания нового вложенного холста, он будет отображаться на панели «Холсты» под материнским холстом.&#x20;
...
* Можно переключать холсты в режиме анимации.\
  Для этого, перейдите в режим анимации, переместите бегунок на нужный кадр и через параметр «Холст» выберете в его значении имя другого вложенного холста. Появится тонкая зеленая полоска на шкале времени, свидетельствуя о том, что на этом кадре произошло переключение. Так же на панели слоя при переключении, будут автоматически заменяться холст с его содержимым, это очень удобно и не создает большое скопление лишних слоев.
...
\
**Поэтому вы можете импортировать вложенные холсты в новые проекты несколькими способами:**&#x20;
...
Вы можете якобы удалить его из списка слоев, но на панели «Холст» он останется. Благодаря этому, если вы удалили слой вложенного холста, его можно будет вернуть на панель слоёв в любой момент.

Чтобы вернуть слой вложенного холста вам следует щелкнуть на любую группу (желательно создать пустую группу) и Щелкнув по параметру «Холст» на панели параметров инструмента, выберите в значении имя вложенного холста.
