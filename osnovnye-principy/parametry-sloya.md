...
<figure><img src="../.gitbook/assets/009-2.png" alt=""><figcaption><p>Панель параметров слоя <strong>Окружность</strong> - дополнительные параметры.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/003-2.gif" alt=""><figcaption><p>Изменение серых параметров слоя на <strong>Рабочей области</strong>.</p></figcaption></figure>

### Контрольные точки

Когда слой выделен, на **Рабочей области** появляются контрольные точки, позволяющие изменять его параметры.

<figure><img src="../.gitbook/assets/27.png" alt=""><figcaption><p><strong>Контрольные точки</strong></p></figcaption></figure>

Существует несколько типов контрольных точек, каждый из которых обладает своим назначением:

<img src="../.gitbook/assets/1 (5).png" alt="" data-size="line"> — **Контрольная точка позиции**. Отвечает за расположение объекта на рабочей области. По сути, это центр объекта относительно которого происходят изменения.

<img src="../.gitbook/assets/2 (1) (1) (1) (1).png" alt="" data-size="line"> — **Контрольная точка вершины.** Перемещая точки вершин можно менять форму произвольной векторной фигуры.

<img src="../.gitbook/assets/3 (1) (1) (1).png" alt="" data-size="line"> — **Контрольная точка касательной.** Отвечает за контроль кривизны сегмента векторного объекта в соответствующей вершине.

<img src="../.gitbook/assets/4 (1) (1).png" alt="" data-size="line"> — **Контрольная точка радиуса.** Позволяет менять радиус окружностей.

<img src="../.gitbook/assets/5 (1) (1) (1).png" alt="" data-size="line"> — **Контрольная точка угла.** С ее помощью мы можем менять наклон объекта и вращать его вокруг центральной точки.

<img src="../.gitbook/assets/8.png" alt="" data-size="line"> — **Контрольная точка толщины.** С помощью этой точки можно изменять толщину контура. Также она применяется у слоя [Деформирующий скелет](https://docs.synfig.ru/perechen-sloyov/deformiruyushii-skelet) для определения радиуса влияния каждой кости.
...
<img src="../.gitbook/assets/duck_radius_icon.png" alt="" data-size="line"> — включить отображение точек радиуса;
...
Вы можете связывать параметры слоёв, чтобы изменение одного параметра влияло на другой параметр этого же или другого слоя. Подробнее об этой функции читайте в статье [«Связывание параметров»](../svyazyvanie-dannykh/svyazyvanie-parametrov.md).
