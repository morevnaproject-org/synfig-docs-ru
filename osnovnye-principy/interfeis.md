...
{% hint style="info" %}
Если интерфейс программы выглядит иначе, возможно, что предыдущий пользователь изменил настройки. Чтобы восстановить исходный вид интерфейса, выполните следующие действия:
