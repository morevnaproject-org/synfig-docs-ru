...
Например, вы можете нажать кнопку **Добавить слой** и выбрать **Геометрия** -> **Окружность** или **Геометрия** -> **Контур**.
...
{% hint style="info" %}
Для многих типов графических слоёв есть более удобный способ добавления  - с помощью инструментов. Подробную информацию об этом смотрите в разделе [Перечень инструментов](../instrumenty/perechen-instrumentov.md).
{% endhint %}
...
Для добавления слоёв в группу выполните следующие действия:

* Выделите необходимые слои.
  * Для выделения нескольких слоёв используйте клавиши **Shift** или **Ctrl**, как описано в предыдущем разделе.
* Нажмите кнопку **Группировать слои** в нижней части **Панели слоёв**.

<figure><img src="../.gitbook/assets/018-2.png" alt=""><figcaption><p>Панель управления слоями. Кнопка <strong>Группировать слои</strong>.</p></figcaption></figure>
...
Чтобы отключить отображения слоя на **Рабочей области**, следует снять галочку, которая расположена слева от слоя.
...
<figure><img src="../.gitbook/assets/2024-03-06_16-33 (1).png" alt=""><figcaption><p><em>Функция <strong>Отключить рендеринг слоя</strong></em></p></figcaption></figure>
