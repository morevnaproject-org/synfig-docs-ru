...
Если вы зажимаете **Shift** при использовании **инструмента трансформации**, перемещаемый объект будет двигаться строго по **горизонтали** или **вертикали**.
...
<figure><img src="../.gitbook/assets/cursor4.gif" alt=""><figcaption><p>Вращение с помощью <strong>инструмента трансформации</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/deforma.gif" alt=""><figcaption><p><strong>Инструмент деформации</strong></p></figcaption></figure>
...
В **меню инструмента** можно выбрать ось, относительно которой точки будут отражены по горизонтали или вертикали.
...
* Наведите курсор мыши на нужный сегмент линии.
* Зажмите левую кнопку мыши и проведите курсором по линии вперёд-назад. В местах перемещения курсора толщина линии будет увеличиваться.
* Удерживая клавишу **Ctrl**, толщина линии будет уменьшаться.

<figure><img src="../.gitbook/assets/thickness.gif" alt=""><figcaption><p>Коррекция толщины контура</p></figcaption></figure>

В **Настройках инструмента** можно менять **«Силу»**, с которой будет увеличиваться или уменьшаться контур, а также **«Радиус»**, который определяет количество контрольных точек, захватываемых при изменении контура.
...
Инструменты **«Окружность»**, **«Прямоугольник»**, **«Астериск»**, **«Многоугольник»** — предназначены для создания объектов с формой, соответствующей их названию.

Тип создаваемого слоя зависит от того, какой тип выбран на **Панели настроек инструмента**.

{% hint style="info" %}
Подробнее о типах создаваемых слоев смотрите в разделе **Перечень слоёв**
{% endhint %}

<figure><img src="../.gitbook/assets/shapes.gif" alt=""><figcaption><p><strong>Окружность</strong>, <strong>Прямоугольник</strong>, <strong>Астериск</strong>, <strong>Многоугольник</strong></p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/5 (1) (1).png" alt=""><figcaption><p>Настройки инструмента <strong>Астериск</strong></p></figcaption></figure>
