...
Для этого следует выделить нужный параметр на «**Панели параметров слоя**» и щелкнув **ПКМ** - «**Запретить анимацию**». После этого параметр станет статичным и напротив него появится иконка с зеленым человечком.
