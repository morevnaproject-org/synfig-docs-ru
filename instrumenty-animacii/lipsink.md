...
<figure><img src="../.gitbook/assets/sound-import (1).png" alt=""><figcaption><p>Рис. 3 Аудиофайл на панели слоёв</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/papag.png" alt=""><figcaption><p>Рис. 4 Стартовое окно Papagayo-NG</p></figcaption></figure>

### Интерфейс

<figure><img src="../.gitbook/assets/papaginterface3 (1).png" alt=""><figcaption><p>Рис. 5 Интерфейс Papagayo-NG</p></figcaption></figure>
...
Первое, что нужно сделать - это импортировать звуковой файл с голосом. Для этого, в левом верхнем углу нажимаем иконку с папкой и выбираем звуковой файл в формате .wav. Или в меню File нажмите Open (рис. 6). &#x20;

<figure><img src="../.gitbook/assets/papagayoimport.gif" alt=""><figcaption><p>Рис. 6 Импорт аудиофайла в Papagayo-NG</p></figcaption></figure>
...
Чтобы это сделать, мы тянем начало зеленого блока и выставляем его на начало фразы. Соответственно, конец зеленого блока на конец фразы (рис. 7).&#x20;

<figure><img src="../.gitbook/assets/papagayostartend.gif" alt=""><figcaption><p>Рис. 7 Задаём начало и конец фразы</p></figcaption></figure>

Таким же образом можно обозначить начало и конец слов с помощью оранжевых блоков (рис. 8).

<figure><img src="../.gitbook/assets/papagayostartend2.gif" alt=""><figcaption><p>Рис. 8 Задаём начало и конец слова</p></figcaption></figure>

А также можно двигать отдельно стоящие фонемы для более точной настройки липсинка (рис. 9).

<figure><img src="../.gitbook/assets/phoneme.gif" alt=""><figcaption><p>Рис. 9 Перемещение фонем</p></figcaption></figure>

После того, как начало и конец фразы/слов выставлены, нажимаем воспроизвести. Рот в окне справа начнет говорить под заданную фразу (рис. 10).

<figure><img src="../.gitbook/assets/papagdifmouth.gif" alt=""><figcaption><p>Рис. 10 Демонстрация липсинка</p></figcaption></figure>
...
Открываем проект Synfig Studio. Нажимаем файл, импортировать и выбираем сохраненный файл из Papagayo-NG.  На панели слоёв появится звукой файл и слой-переключатель, который содержит пустые группы с фонемами (рис. 11).

<figure><img src="../.gitbook/assets/pgogroup.png" alt=""><figcaption><p>Рис. 11 Файл из Papagayo-NG импортированый в Synfig</p></figcaption></figure>

Заполняем эти группы фонемами, которые мы создали/нарисовали ранее (рис. 12). Недостающие фонемы компенсируем существующими по сокращенному списку фонем (рис. 2).

<figure><img src="../.gitbook/assets/papagayosynf.gif" alt=""><figcaption><p>Рис. 12 Перемещение фонем в группы переключателя слоёв</p></figcaption></figure>

После того, как все фонемы были перенесены в группы в слой-переключатель, липсинк готов. При воспроизведении анимации, персонаж начнет говорить (рис. 13).

<figure><img src="../.gitbook/assets/resultpapag.gif" alt=""><figcaption><p>Рис. 13 Результат липсинка через Papagayo-NG</p></figcaption></figure>
...
Исходя из этих четырех пунктов, фраза "Мыине такое вказарме слушаем" превращается в "Мыинет аоев арес ушаем" (рис 14).

<figure><img src="../.gitbook/assets/beforeafter.gif" alt=""><figcaption><p>Рис. 14 Сравнение липсинка до и после сокращения фонем</p></figcaption></figure>

{% hint style="info" %}
Не всегда эти подсказки приводят к желаемому результату, поэтому важно экпериментировать и проверять каждое изменение.
{% endhint %}

Сохраняем файл. Изменения, внесенные в Papagayo-NG, будут автоматически применены к проекту Synfig (рис. 15).&#x20;

<figure><img src="../.gitbook/assets/beforeafter2.gif" alt=""><figcaption><p>Рис. 15 Сравнение липсинка до и после сокращения фонем</p></figcaption></figure>
