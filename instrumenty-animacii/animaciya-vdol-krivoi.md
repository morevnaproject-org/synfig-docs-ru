...
Создаем произвольный объект. Для наглядности создадим стрелку с помощью инструмента [Кривые](../instrumenty/krivye.md), так мы будем видеть направление движения.
...
{% hint style="warning" %}
Шаг выше можно пропустить, при условии если вы выставите центр вращения группы со стрелкой на следующем шаге. Как это сделать смотрите в разделе **Параметры слоя** 0, рисунок 16.
{% endhint %}
