...
Отображение ключевых кадров на временной шкале могут представать в трех видах:&#x20;
...
Помимо создания ключевого кадра, вы так же можете управлять им, вносить некоторые изменения с помощью всплывающего меню, которое появляется, при щелчке **ПКМ** на ключевой кадр.

<figure><img src="https://lh7-us.googleusercontent.com/2UkuvBdhr70JV-5GI55dWuLUUfRsR-EnPXH0LiKo0TgBNHkGnnlI1msZYSQDS2JcPKQYLLCUv7ZoSmYA4-fo3SP1iNl45zcZqlhD-CSh-RynS8p5fn2PxLEXb13t3PWfZY09JM5jrGiQkxzY65Ko0bA" alt=""><figcaption></figcaption></figure>

На рисунке выше вы можете заметить, что первые две панели неактивны, это связано с тем, что бегунок времени стоит на том же кадре, где уже создан ключевой кадр. Чтобы воспользоваться первыми двумя функциями, перенесите бегунок времени на нужный вам кадр.

***

### Удаление ключевого кадра

Удалить ключевой кадр можно через две панели:&#x20;

* **Панель «Шкалы времени»**;&#x20;
* **Панель «Ключевые кадры»**.

![](https://lh7-us.googleusercontent.com/_HexauKPQXBZJzAwxfWQF8ZVc7ZKzfcwUK-S7U34bjbNc33TidUzS7lOB_4nHhdh3EDfsiFEmLbM1t3UfnHvblq47vFlqOqLMbFHAbKEawYhSQ3qws3bjo-j64IPJmjEJPVjYY0RNk1L-WugepViVsA)![](https://lh7-us.googleusercontent.com/mxI2lQYA9aBkLg7I3IKLHiARoYKFCY6V3cemqE-aTQfNrfCbAUgwLFydIQBsYmwJFvM2aOkADBeeVZzc83l_iW8WmK_WExBlMGtOOMFk27K2aEKbeQC-lI1eD08y5i-HFNDX2-rpjki2_r6NoUW0KwM)<br>
...
Чтобы открыть окно со свойствами ключевого кадра, выполните следующие шаги:

1. Щёлкните **правой кнопкой мыши (ПКМ)** на нужный ключевой кадр.
2. В появившемся контекстном меню выберите **«Свойства ключевого кадра»**.

После этого откроется окно с параметрами выбранного ключевого кадра.

<figure><img src="https://lh7-us.googleusercontent.com/0BymyjadWZHg-YIxo9SFVjH2bHSasx0woHzebJVrLqOP3B1u_E0CTeWlc5dswRlDmNoCwQngmllBo7L9N5lEYoRcuCPbqd5sbkJP3SmL4A_yyO2Bc6rtPF4rihNTfIKLe_MCBxQIjOxV4iRV0tEoqLQ" alt=""><figcaption></figcaption></figure>

В окне свойств ключевого кадра доступны следующие параметры:

* **Описание** – текст, который будет отображаться при наведении курсора на ключевой кадр.
* **Действующий** – см. подробнее в разделе **«Неактивный ключевой кадр»**.
* **Вход** – позволяет настроить вход интерполяции для всех фиксаторов, находящихся на ключевом кадре.
* **Выход** – позволяет настроить выход интерполяции для всех фиксаторов на ключевом кадре (см. подробнее **«Интерполяция»** в разделе **«Фиксаторы»**).
...
<figure><img src="https://lh7-us.googleusercontent.com/qJU6mk1z01ybNuVKSUYYza40elPRT8VeKhLU3NlaK7rFPau9YMIH7CkBAA-hnGCjqSNxKDqO-0vXGRcuvRC-OAw8HOcdXkmPXOwtm-n4KpBt5pPVwXSCB893ODpQ1jlgMhnk2NspzdDNE7DQkCOUSbM" alt=""><figcaption></figcaption></figure>
