...
Для того, чтобы создать слой скелета, вам следует щелкнуть на панели слоев значок **Создать слой**, После этого выбрать из списка **Другое** → **Скелет**.
...
На **панели слоёв** появится слой скелета, в котором уже есть одна кость. На рабочей области она выглядит как линия с тремя разными точками.&#x20;
...
Для того, чтобы создать еще кость, которая будет подчиняться той, которая уже есть, Следует щелкнуть **правой кнопкой мыши** по любой точке кости и выбираем **Создать дочернюю кость**.
