...
Для этого необходимо включить точки **Ширены** (подробнее см. раздел **Параметры слоя → Контрольные точки**).

Затем увеличьте радиусы точек ширены так, чтобы были захвачены все точки векторных слоёв.

После этого нажмите `Ctrl + A` (выделить всё), чтобы выделить все точки.\
Далее щёлкните **ПКМ** по скелету и выберите **Привязать к скелету**.
